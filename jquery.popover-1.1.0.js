 ...
 *
 * FORKED AND HACKED BY JAAARRRYYYYYYY
 */
...
;(function($) {
  var defaults = {
    ...
    content: false, //content of the popover; jquery selector or string of HTML
  ...
  var _ = {
    ...
    pop_position_class: function(popover, position) {
      ...
      if(position == 'top') {
        ...
        remove = "popover-top popover-bottom popover-left";
        arrow = 'left-arrow';
      ...
      return this.each(function() {
        ...
        if(!data) {
          var popover = $('<div class="popover">')
            ...
            .append('<div class="popover-wrap"></div>')
            .appendTo('body')
            .hide();
          ...
          if(options.title)
            $('<div class="popover-title">')
              ...
              .appendTo(popover.find('.popover-wrap'));
          if(options.content)
            $('<div class="popover-content">')
              .html(options.content instanceof jQuery ? options.content.remove() : options.content)
              .appendTo(popover.find('.popover-wrap'));
    ...
    reposition: function() {
      return this.each(function() {
        ...
        if(data) {
          ...
          if(position == 'auto') {
            ...
            $.each(positions, function(i, pos) {
              ...
              if(x1 < 0 || x2 < 0 || y1 < 0 || y2 < 0) {
                ...
                sideDiff = x1 - options.horizontalOffset;
              }
              ...
              if(x2 > windowWidth) {
                ...
                sideDiff = calc.x2 - windowWidth + options.horizontalOffset;
              }
          ...
          if(sideDiff && sideDiff > 0) {
            // Out of bounds right
            newLeft = newLeft - sideDiff;
            var arrow = popover.find('.popover-arrow');
            arrow.css('marginLeft', '');
            arrow.css('marginLeft', parseInt(arrow.css('marginLeft')) + sideDiff);
          } else if(sideDiff < 0) {
            // Out of bounds left
            newLeft = options.horizontalOffset;
            var arrow = popover.find('.popover-arrow');
            arrow.css('marginLeft', '');
            arrow.css('marginLeft', parseInt(arrow.css('marginLeft')) + sideDiff);
          }
    ...
    title: function(text) {
      return this.each(function() {
        ...
        if(data) {
          ...
          var wrap = data.popover.find('.popover-wrap');
          if(title.length === 0)
